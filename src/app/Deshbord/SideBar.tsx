...
export default function Sidebar() {
    return (
        <aside className="relative  h-full flex flex-col bg-clip-border rounded-none bg-gray-900 from-gray-900 to-gray-800 text-white shadow-gray-900/20 shadow-md w-[200px] max-w-[20rem] p-8 border-white/80 bg-opacity-80 backdrop-blur-2xl backdrop-saturate-200">
